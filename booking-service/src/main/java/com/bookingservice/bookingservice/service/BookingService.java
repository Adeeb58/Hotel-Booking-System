...
public class BookingService {
    ...
    private final com.bookingservice.bookingservice.client.UserServiceClient userServiceClient;
    ...
    public BookingService(BookingRepository bookingRepository,
                          ...
                          com.bookingservice.bookingservice.client.UserServiceClient userServiceClient) {
    ...
    public BookingResponse confirmBooking(Long bookingId) {
        ...
        try {
            com.bookingservice.bookingservice.client.dto.UserDTO user = userServiceClient.getUserById(booking.getUserId());
            com.bookingservice.bookingservice.client.dto.HotelSummary hotel = hotelServiceClient.getHotelById(booking.getHotelId());
            com.bookingservice.bookingservice.client.dto.RoomSummary room = hotelServiceClient.getRoom(booking.getRoomId());

            String hotelName = hotel != null ? hotel.name() : "Unknown Hotel";
            String roomType = room != null ? room.roomType() : "Unknown Room";
