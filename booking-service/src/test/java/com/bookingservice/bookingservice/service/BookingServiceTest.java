...
class BookingServiceTest {
    ...
    @Mock
    private com.bookingservice.bookingservice.client.UserServiceClient userServiceClient;

    private BookingService bookingService;

    @BeforeEach
    void setUp() {
        bookingService = new BookingService(bookingRepository, notificationClient, hotelServiceClient, paymentServiceClient, userServiceClient);
    }
